...
public class FIBHtmlEditorImpl extends FIBWidgetImpl {
	...
	{
		return optionsInLine1.contains(option)
				|| optionsInLine2.contains(option)
				|| optionsInLine3.contains(option);
	}
